 ...
 */
router.put('/:usuario_id', userValidator ,usuariosController.updateUsers);
...
router.get('/logout', (req, res) => {
    if (req.user) {
        ...
        return res.status(200).json({ msg: 'Adios' })
      } else {
        return res.status(400).json({ msg: 'No hay usuarios logueados' })
      }
});
 ...
 *
 */
router.delete('/:usuario_id' , usuariosController.deleteUsers);
